...
public class Money
{
    private long dollars; //HERE! this is a private instance var
    private long cents;
    public void set (long newDollars) //HERE! this is an overloaded method
    {
        if (newDollars < 0)
        {
            System.out.println (
    ...
    */
    public Money times (int n) //HERE! this is a constructor
    {
